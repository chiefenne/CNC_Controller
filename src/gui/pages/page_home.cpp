...
void page_home_create(lv_obj_t *parent)
{
    ...
    lv_label_set_text_fmt(lbl_x, "X=%7.3f", cnc.machine_pos[0]);
    ...
    lv_label_set_text_fmt(lbl_y, "Y=%7.3f", cnc.machine_pos[1]);
    ...
    lv_label_set_text_fmt(lbl_z, "Z=%7.3f", cnc.machine_pos[2]);
